...
error_img = pygame.image.frombytes(error_img_data, error_img.size, error_img.mode)
#load attribution for files
#load images tiles
try:
    ground_tiles_img = pygame.image.load('game_files/imgs/tiles/tiles_background.png')
except:
    ground_tiles_img = error_img
try:
    interactable_tiles_img = pygame.image.load('game_files/imgs/tiles/tiles_interactable.png')
except:
    interactable_tiles_img = error_img
interactable_tiles_img = pygame.transform.scale(interactable_tiles_img, (interactable_tiles_img.get_width() * 2, interactable_tiles_img.get_height() * 2))
#load images gui
try:
    inventory_slots = pygame.image.load('game_files/imgs/gui/inventory_slots.png')
except:
    inventory_slots = error_img
inventory_slots = pygame.transform.scale(inventory_slots, (tile_size * 3 * 7, tile_size * 3))
try:
    inventory_bg = pygame.image.load('game_files/imgs/gui/inventory_background.png')
except:
    inventory_bg = error_img
try:
    inventory_page = pygame.image.load('game_files/imgs/gui/inventory_page.png')
except:
    inventory_page = error_img
inventory_page_left = inventory_page
inventory_page_right = pygame.transform.flip(inventory_page, True, False)
try:
    respawn_bg = pygame.image.load('game_files/imgs/gui/respawn_bg.png')
except:
    respawn_bg = error_img
try:
...
try:
    ...
    setting_bg = error_img
try:
    keybinds_display = pygame.image.load('game_files/imgs/menu/keybinds_selector.png')
except:
    keybind_display = error_img
try:
    logo = pygame.image.load('game_files/imgs/menu/logo.png')
except:
    logo = error_img
try:
    player_select_bg = pygame.image.load('game_files/imgs/gui/scroll_bg.png')
except:
    player_select_bg = error_img
player_select_bg = pygame.transform.scale(player_select_bg, (600, 600))
...
try:
    ...
    item_imgs = error_img
item_imgs = pygame.transform.scale(item_imgs, (tile_size * 3 * 7, tile_size * 3 * 4))
...
combined_inventory_button = pygame.image.load('game_files/imgs/menu/combined_stack_button.png')
combined_inventory_button = pygame.transform.scale(combined_inventory_button, (tile_size * 3, tile_size * 3))
combined_inventory_button_hover = pygame.image.load('game_files/imgs/menu/combined_stack_button_hover.png')
combined_inventory_button_hover = pygame.transform.scale(combined_inventory_button_hover, (tile_size * 3, tile_size * 3))
combined_inventory_button_click = pygame.image.load('game_files/imgs/menu/combined_stack_button_click.png')
combined_inventory_button_click = pygame.transform.scale(combined_inventory_button_click, (tile_size * 3, tile_size * 3))
...
charachter_button_img = pygame.image.load('game_files/imgs/menu/charachter_button.png')
charachter_button_img = pygame.transform.scale(charachter_button_img, (tile_size * 6, tile_size * 3))
charachter_button_hover = pygame.transform.scale(charachter_button_img, (tile_size * 8, tile_size * 4))
#load music
...
if path.exists('game_files/settings/settings.json'):
    with open('game_files/settings/settings.json', 'r') as settings_loaded:
        ...
        current_player = loaded_settings[4]
#load credit TXTs
...
class License_Back():
    ...
    def update(self):
        ...
        return False
#set input boxes
world_name_input = Input_Box(300, 180, 100, 30, colour_active, colour_inactive, 'centre')
seed_input = Input_Box(300, 250, 100, 30, colour_active, colour_inactive, 'centre')
world_name_change = Input_Box(300, 200, 100, 30, colour_active, colour_inactive, 'centre') 
devtools_code = Input_Box(350, 1050, 100, 30, settings_bg_colour_active, settings_bg_colour, 'centre')
h_input =  Input_Box(340, 390, 65, 30, colour_inactive, (0, 0, 0), 'centre', 3)
s_input =  Input_Box(407, 390, 65, 30, colour_inactive, (0, 0, 0), 'centre', 3)
v_input =  Input_Box(474, 390, 65, 30, colour_inactive, (0, 0, 0), 'centre', 3)
r_input =  Input_Box(340, 440, 65, 30, colour_inactive, (0, 0, 0), 'centre', 3)
g_input =  Input_Box(407, 440, 65, 30, colour_inactive, (0, 0, 0), 'centre', 3)
b_input =  Input_Box(474, 440, 65, 30, colour_inactive, (0, 0, 0), 'centre', 3)
hex_input =  Input_Box(372.5, 490, 130, 30, colour_inactive, (0, 0, 0), 'centre', 7)
#set up classes
inventory = Inventory()
hotbar = Hotbar()
player = Player(293, 315)
select_world = Select_World()
select_charachter = Select_Charachter()
player.get_player_image()
inventory.get_player_image()
setting_selector = Select_Setting()
set_keybinds = Keybinds()
#get keybinds
keybinds = set_keybinds.get_keybinds()
#set buttons
...
edit_player_button = Button(300, 420, button_img, button_hover_img, "Player", white)
...
done_charachter_button = Button(300, 500, charachter_button_img, charachter_button_hover, "Done", (0, 0, 0))
edit_charachter_button = Button(300, 450, charachter_button_img, charachter_button_hover, "Edit", (0, 0, 0))
back_charachter_button = Button(183, 80, charachter_button_img, charachter_button_hover, "Back", (0, 0, 0))
charachter_hair_button = Button(183, 130, charachter_button_img, charachter_button_hover, "Hair", (0, 0, 0))
charachter_eyes_button = Button(183, 172, charachter_button_img, charachter_button_hover, "Eyes", (0, 0, 0))
charachter_skin_button = Button(183, 214, charachter_button_img, charachter_button_hover, "Skin", (0, 0, 0))
charachter_shirt_button = Button(183, 256, charachter_button_img, charachter_button_hover, "Shirt", (0, 0, 0))
charachter_pants_button = Button(183, 298, charachter_button_img, charachter_button_hover, "Pants", (0, 0, 0))
charachter_shoes_button = Button(183, 340, charachter_button_img, charachter_button_hover, "Shoes", (0, 0, 0))
swap_gender = Button(400, 80, charachter_button_img, charachter_button_hover, "Swap Gender", (0, 0, 0))
license_back_button = License_Back()
#view attribution buttons
numpy_button =  Button(400, 160, button_img, button_hover_img, "View License", white)
open_simplex_button =  Button(400, 220, button_img, button_hover_img, "View License", white)
pillow_button =  Button(400, 280, button_img, button_hover_img, "View License", white)
pyperclip_button =  Button(400, 340, button_img, button_hover_img, "View License", white)
pygame_ce_button =  Button(400, 400, button_img, button_hover_img, "View License", white)
medieval_sharp_button =  Button(400, 460, button_img, button_hover_img, "View License", white)
DM_Serif_Text_button =  Button(400, 520, button_img, button_hover_img, "View License", white)
#set scroll bars - max length 37
controls_scroll_bar = Scroll_Bar(7, 1)
devtools_controls_scroll_bar = Scroll_Bar(1, 1)
audio_settings_scroll_bar = Scroll_Bar(37, 1)
license_settings_scroll_bar = Scroll_Bar(0.5, 15)
...
while run == True:
            ...
            for x in range(7):
                ...
                for tile in game_map[target_chunk]:
                    if tile[1] in [1]:
                        ...
                        screen.blit(ground_tiles_img, (tile[0][0]*16-scroll[0],tile[0][1]*16-scroll[1]), (0, 0, 16, 16))
                    elif tile[1] in [2]:
                        water_rects.append([pygame.Rect(tile[0][0]*16-scroll[0],tile[0][1]*16-scroll[1],16,16), target_chunk, tile, tile[2]])
                        screen.blit(ground_tiles_img, (tile[0][0]*16-scroll[0],tile[0][1]*16-scroll[1]), (16, 0, 16, 16))
                    #update debug menu if enabled
                    if debug_menu == True and game_state == 0:
                        #check if center of player collides with tile to figure out what chunk they are in
                        if pygame.Rect(tile[0][0]*16-scroll[0],tile[0][1]*16-scroll[1],16,16).collidepoint((player.hitbox.centerx, player.hitbox.centery)):
                           chunk_debug = target_chunk
                    #only run interactable/colelctble stuff if the object is a class
                    if tile[2] != None:
                        #move img rect based on scroll
                        if tile[1] in [1]:
                            game_map[target_chunk][tile[2].chunk_location][2].rect.x = grass_rects[-1][0].x
                            game_map[target_chunk][tile[2].chunk_location][2].rect.y =  grass_rects[-1][0].y
                        elif tile[1] in [2]:
                            game_map[target_chunk][tile[2].chunk_location][2].rect.x = water_rects[-1][0].x
                            game_map[target_chunk][tile[2].chunk_location][2].rect.y =  water_rects[-1][0].y
                        #blit img
                        interactable_surface.blit(interactable_tiles_img, tile[2].rect, tile[2].img_coords)
                        if debug == True:
                        ...
                        if isinstance(tile[2], Collectable):
                            ...
                            if tile[2].rect.colliderect(player.hitbox):
                                if inventory.collect_item(tile[2].item_num):
                                    game_map[tile[2].chunk][tile[2].chunk_location][2] = None
                                    hotbar.get_slot_data()
    ...
    for event in pygame.event.get():
        ...
        if game_state == 0:
            ...
            inventory.get_event(event)
        elif game_state == 3:
            world_name_input.update(event)
            seed_input.update(event)
        elif game_state == 8:
            world_name_change.update(event)
        elif game_state == 9:
            if settings_state == 'controls':
                set_keybinds.get_event(event)
        elif game_state == 'edit_player':
            h_input.update(event)
            s_input.update(event)
            v_input.update(event)
            r_input.update(event)
            g_input.update(event)
            b_input.update(event)
            hex_input.update(event)
        elif game_state == 'view_attributions':
            license_settings_scroll_bar.get_scroll_wheel(event)
    #print player stuff
    if game_state == 0:
        #run entity stuff
        ...
        for entity in game_engines.enitites.entitie_dict:
            game_map = game_engines.enitites.entitie_dict[entity].update(player, scroll, debug, screen, water_rects, grass_rects, Collectable, game_map, entity_sfx, sfx)
        for projectile in game_engines.enitites.projectiles:
            game_engines.enitites.projectiles[projectile].update(player, scroll, screen, debug)
        ...
        player.armour()
        player.health()
        game_engines.enitites.spawn_entities(world_difficulties, world_num, player)
        if coords_on == True:
            draw_text(str(scroll), font, white, 10, 10)
        #save evry 5 minutes
        if time.time() - save_time == 5:
            save_world(world_num, game_map, inventory.slots, player.hearts['health_count'], true_scroll, player.rect.x, player.rect.y, player.direction, game_engines.enitites.entitie_dict)
            save_time = time.time()
        else:
            save_timer += 1
    elif game_state == 1:
        ...
        if save_and_quit_button_dead.draw(0):
            save_world(world_num, game_map, inventory.slots, inventory.armour_slots, inventory.hotbar_slots, player.hearts['health_count'], true_scroll, player.rect.x, player.rect.y, player.direction, game_engines.enitites.entitie_dict)
            world_seed = 0
            game_map = {}
        ...
        if select_back_button.draw(0):
            game_state = 7
        world_name_generating = world_name_input.draw(0)
        draw_text('World Name:', font, white, 210, 140)
        seed_generating = seed_input.draw(0)
        ...
        save_world(world_num, {}, temp_inventory, 20, [0,0], 293, 315, 2, game_engines.enitites.entitie_dict)
        game_state = 5
    elif game_state == 5:
        ...
        draw_text('Food Wars V1.1', font, white, 5, 570)
        if play_button.draw(0):
            game_state = 7
        if settings_button.draw(0):
            game_state = 9
        if edit_player_button.draw(0):
        ...
        if world_one_settings.draw(0):
            if world_generated[1] == True:
                world_num = 1
                game_state = 8
                world_name_change.ime_text = world_names[world_num]
        ...
        if delete_state == 0:
            ...
            world_name_settings = world_name_change.draw(0)
        ...
        settings_state = setting_selector.update(ingame)
        #save and change state if back button is pressed
        if settings_state == 'back':
            save_settings()
            set_keybinds.get_keybinds()
            if ingame:
                #save new difficulty
        ...
        if settings_state == 'audio':
            ...
            if sfx == True:
                if sfx_on_button.draw(0):
                    sfx = False
            else:
                if sfx_off_button.draw(0):
                    sfx = True
            if music == True:
                if music_on_button.draw(0):
                    music = False
            else:
                if music_off_button.draw(0):
                    music = True
        ...
        screen.blit(settings_bg, (0, 0))
        license_scroll = license_settings_scroll_bar.update()
        draw_license_text(license_image, license_scroll)
        if license_back_button.update():
            game_state = 9
    elif game_state == 'select_player':
        screen.blit(player_select_bg, (0, 0))
        select_charachter.update()
        if done_charachter_button.draw(0):
            player.get_player_image()
            inventory.get_player_image()
            game_state = 6
        #only can edit if not on a defult
        if select_charachter.current_player != 1 and select_charachter.current_player != 2:
            if edit_charachter_button.draw(0):
                select_charachter.edit_setup()
                game_state = 'edit_player'
        else:
            draw_text('Default', font, (0, 0, 0), 260, 435)
    elif game_state == 'edit_player':
        screen.blit(player_select_bg, (0, 0))
        if back_charachter_button.draw(0):
            #save genders, images, and current player
            select_charachter.save_genders()
            select_charachter.save_players()
            save_settings()
            game_state = 'select_player'
        #draw input boxes    
        h = h_input.draw(0)
        ...
        g = g_input.draw(0)
        b = b_input.draw(0)
        hexcode = hex_input.draw(0)
        #draw input box labels
        draw_text('h', font_inventory, colour_inactive, 335, 372)
        draw_text('s', font_inventory, colour_inactive, 402, 372)
        draw_text('v', font_inventory, colour_inactive, 469, 372)
        draw_text('r', font_inventory, colour_inactive, 335, 422)
        draw_text('g', font_inventory, colour_inactive, 402, 422)
        draw_text('b', font_inventory, colour_inactive, 469, 422)
        draw_text('hex', font_inventory, colour_inactive, 360, 472)
        #draw divider lines
        ...
        try:
            ...
            if int(h) != select_charachter.colour_picker_colour['hsv'][0]:
                print(8)
                if int(h) <= 360 and int(h) >= 0:
                    select_charachter.change_pos_on_input('h', h)
                else:
                    select_charachter.reset_inputs()
            elif int(s) != select_charachter.colour_picker_colour['hsv'][1]:
                if int(s) <= 100 and int(s) >= 0:
                    select_charachter.change_pos_on_input('s', s)
                else:
                    select_charachter.reset_inputs()
            elif int(v) != select_charachter.colour_picker_colour['hsv'][2]:
                if int(v) <= 100 and int(v) >= 0:
                    select_charachter.change_pos_on_input('v', v)
                else:
                    select_charachter.reset_inputs()
            elif int(r) != select_charachter.colour_picker_colour['rgb'][0]:
                if int(r) <= 255 and int(r) >= 0:
                    select_charachter.change_pos_on_input('r', r)
                else:
                    select_charachter.reset_inputs()
            elif int(g) != select_charachter.colour_picker_colour['rgb'][1]:
                if int(g) <= 255 and int(g) >= 0:
                    select_charachter.change_pos_on_input('g', g)
                else:
                    select_charachter.reset_inputs()
            elif int(b) != select_charachter.colour_picker_colour['rgb'][2]:
                if int(b) <= 255 and int(b) >= 0:
                    select_charachter.change_pos_on_input('b', b)
                else:
                    select_charachter.reset_inputs()
            elif hexcode != select_charachter.colour_picker_colour['hex']:
                select_charachter.change_pos_on_input('hex', hexcode)
        except:
            #just reset if bad input
            select_charachter.reset_inputs()
        #Run selection buttons. Only show buttons if they can be pressed
        if select_charachter.get_editing() == 'hair':
            screen.blit(charachter_hair_button.txt_surface, (charachter_hair_button.rect.centerx - (charachter_hair_button.text_width / 2), charachter_hair_button.rect.centery - 15))
        else:
            if charachter_hair_button.draw(0):
                select_charachter.set_editing('hair')
        if select_charachter.get_editing() == 'skin':
            screen.blit(charachter_skin_button.txt_surface, (charachter_skin_button.rect.centerx - (charachter_skin_button.text_width / 2), charachter_skin_button.rect.centery - 15))
        else:
            if charachter_skin_button.draw(0):
                select_charachter.set_editing('skin')
        if select_charachter.get_editing() == 'eyes':
            screen.blit(charachter_eyes_button.txt_surface, (charachter_eyes_button.rect.centerx - (charachter_eyes_button.text_width / 2), charachter_eyes_button.rect.centery - 15))
        else:
            if charachter_eyes_button.draw(0):
                select_charachter.set_editing('eyes')
        if select_charachter.get_editing() == 'shirt':
            screen.blit(charachter_shirt_button.txt_surface, (charachter_shirt_button.rect.centerx - (charachter_shirt_button.text_width / 2), charachter_shirt_button.rect.centery - 15))
        else:
            if charachter_shirt_button.draw(0):
                select_charachter.set_editing('shirt')
        if select_charachter.get_editing() == 'pants':
            screen.blit(charachter_pants_button.txt_surface, (charachter_pants_button.rect.centerx - (charachter_pants_button.text_width / 2), charachter_pants_button.rect.centery - 15))
        else:
            if charachter_pants_button.draw(0):
                select_charachter.set_editing('pants')
        if select_charachter.get_editing() == 'shoes':
            screen.blit(charachter_shoes_button.txt_surface, (charachter_shoes_button.rect.centerx - (charachter_shoes_button.text_width / 2), charachter_shoes_button.rect.centery - 15))
        else:
            if charachter_shoes_button.draw(0):
                select_charachter.set_editing('shoes')
        if swap_gender.draw(0):
            select_charachter.swap_genders()
        #run editor code. Needs to be at bottom or input boxes don't work
        select_charachter.edit()
    #refresh the screen
